...
def get_user_router() -> Router:
        ...
        try:
            ...
            if not result:
                await message.edit_text(
                    ...
                    "Проверьте у этого хоста: URL панели, логин/пароль и ID входящего подключения (inbound)."
                )
                return
            ...
            final_text = get_purchase_success_text(
                ...
                new_expiry_date,
                unified_url or result['connection_string']
            )
    ...
    async def buy_new_key_handler(callback: types.CallbackQuery):
        ...
        await callback.message.edit_text(
            ...
            "Выберите сервер для первичной выдачи ключа:",
