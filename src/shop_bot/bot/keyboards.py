...
def create_platform_download_keyboard(platform: str, subscription_url: str | None = None) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    p = (platform or "").lower()
    if p == "android":
        builder.button(
    ...
    if subscription_url:
        try:
            ...
            if token and parsed.scheme and parsed.netloc:
                # Telegram buttons should use http/https URL.
                # HTTPS activator page then redirects to happ:// deeplink.
