...
def create_webhook_app(bot_controller_instance):
    ...
    def unified_subscription_route(token: str):
        ...
        # Guard against recursive self-calls when host subscription URL is set to /sub/<token>.
        self_prefix = request.host_url.rstrip("/") + "/sub/"
        ...
        for key in keys:
            try:
                ...
                if not sub_url:
                    continue
                if sub_url.startswith(self_prefix):
