...
def create_webhook_app(bot_controller_instance):
    ...
    def activate_subscription_route(token: str):
        ...
        deeplink = f"happ://add?url={urllib.parse.quote(sub_url, safe='')}"
...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <a class="btn btn-primary" href="{deeplink}">Открыть в Happ</a>
  ...
  <script>
    setTimeout(function() {{ window.location.href = {json.dumps(deeplink)}; }}, 120);
  </script>
</body>
</html>"""
