...
class BotController:
    ...
    def start(self):
        ...
        try:
            ...
            platega_flag = database.get_setting("platega_enabled")
            platega_merchant_id = database.get_setting("platega_merchant_id")
            platega_secret_key = database.get_setting("platega_secret_key")
            platega_enabled = (
                str(platega_flag).lower() in ("true", "1", "yes", "on")
            ) and bool(platega_merchant_id and platega_secret_key)
