...
def create_host(
    ...
    try:
        ...
        with sqlite3.connect(DB_FILE) as conn:
            ...
            try:
                cursor.execute(
                    "INSERT INTO xui_hosts (host_name, host_url, host_username, host_pass, host_inbound_id, host_order, subscription_url, client_monthly_traffic_gb) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
                    (name, url, user, passwd, inbound, next_order, subscription_url, client_monthly_traffic_gb)
                )
